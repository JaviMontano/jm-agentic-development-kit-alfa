...
description: "Builds accessible modal dialogs, navigation patterns, and interactive UI components with ARIA and focus trapping."
tools:
  - Read
  - Write
  - Edit
...
Builds accessible modal dialogs, navigation patterns, and interactive UI components with ARIA and focus trapping. Operates within the triad pattern as Lead or Support agent.
