---
name: error-handler
description: "Implements error handling patterns: try/catch, error boundaries, fallback UI, offline error states."
tools:
  - Read
  - Write
  - Edit
...
Implements error handling patterns: try/catch, error boundaries, fallback UI, offline error states. Operates within the triad pattern as Lead or Support agent.
