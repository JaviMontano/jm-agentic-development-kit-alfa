...
description: "Runs Lighthouse CI audits with performance budgets, accessibility thresholds, and Core Web Vitals enforcement."
tools:
  - Read
  - Write
  - Edit
...
Runs Lighthouse CI audits with performance budgets, accessibility thresholds, and Core Web Vitals enforcement. Operates within the triad pattern as Lead or Support agent.
