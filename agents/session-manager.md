...
description: "Session protocol enforcement: context loading, state recovery, pending closure, next steps proposal."
tools:
  - Read
  - Write
  - Edit
...
Session protocol enforcement: context loading, state recovery, pending closure, next steps proposal. Operates within the triad pattern as Lead or Support agent.
