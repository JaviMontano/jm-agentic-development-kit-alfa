...
version: 1.0.0
description: >
  Manage token budget across multi-agent conversations. Progressive disclosure, context pruning.
...
Manage token budget across multi-agent conversations. Progressive disclosure, context pruning. This is an orchestration-layer skill used internally by Pristino and the adk-orchestrator. Protocol details in PRISTINO.md.
