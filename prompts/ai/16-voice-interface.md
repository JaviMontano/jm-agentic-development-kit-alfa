---
name: 16-voice-interface
category: ai
version: 2.0.0
description: "Speech-to-text, text-to-speech, voice UI patterns, accessibility."
triad:
  lead: "prompt-engineering-specialist"
  support: "ai-safety-specialist"
  guardian: "quality-guardian"
skills: ["voice-interface"]
...
- Load skill guidelines: `skills/voice-interface/knowledge/body-of-knowledge.md`
...
**Delivers**: Speech-to-text, text-to-speech, voice UI patterns, accessibility.
