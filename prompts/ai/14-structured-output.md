---
name: 14-structured-output
category: ai
version: 2.0.0
description: "JSON mode, schema-constrained generation, output validation, error recovery."
triad:
...
- Load skill guidelines: `skills/structured-output/knowledge/body-of-knowledge.md`
...
**Delivers**: JSON mode, schema-constrained generation, output validation, error recovery.
