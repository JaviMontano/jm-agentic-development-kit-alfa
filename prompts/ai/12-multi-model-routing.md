---
name: 12-multi-model-routing
category: ai
version: 2.0.0
description: "Model selection by task complexity, cost optimization, fallback chains."
triad:
...
- Load skill guidelines: `skills/multi-model-routing/knowledge/body-of-knowledge.md`
...
**Delivers**: Model selection by task complexity, cost optimization, fallback chains.
