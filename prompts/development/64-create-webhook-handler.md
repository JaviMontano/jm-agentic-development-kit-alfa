---
name: 64-create-webhook-handler
category: development
version: 2.0.0
description: "Create a webhook handler with signature verification"
triad:
  lead: "frontend-craftsman"
  support: "accessibility-designer"
  guardian: "quality-guardian"
skills: ["create-webhook-handler"]
...
- Load skill guidelines: `skills/create-webhook-handler/knowledge/body-of-knowledge.md`
...
**Delivers**: Create a webhook handler with signature verification
