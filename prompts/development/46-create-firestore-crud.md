...
skills: ["create-firestore-crud"]
output-formats: ["html", "md"]
---

# Createfirestore Crud

> Creates a complete Firestore CRUD service with create, read, update, delete, list, and real-time listener functions
...
- Load skill guidelines: `skills/create-firestore-crud/knowledge/body-of-knowledge.md`
...
**Delivers**: Creates a complete Firestore CRUD service with create, read, update, delete, list, and real-time listener functions
