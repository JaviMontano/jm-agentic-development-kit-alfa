---
name: 61-create-error-boundary
category: development
version: 2.0.0
description: "Create error boundary component with fallback UI"
triad:
  lead: "frontend-craftsman"
  support: "accessibility-designer"
  guardian: "quality-guardian"
skills: ["create-error-boundary"]
...
- Load skill guidelines: `skills/create-error-boundary/knowledge/body-of-knowledge.md`
...
**Delivers**: Create error boundary component with fallback UI
