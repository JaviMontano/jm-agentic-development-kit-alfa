---
name: 66-create-service-worker
category: development
version: 2.0.0
description: "Create a service worker for offline support and caching"
triad:
  lead: "frontend-craftsman"
  support: "accessibility-designer"
  guardian: "quality-guardian"
skills: ["create-service-worker"]
...
- Load skill guidelines: `skills/create-service-worker/knowledge/body-of-knowledge.md`
...
**Delivers**: Create a service worker for offline support and caching
