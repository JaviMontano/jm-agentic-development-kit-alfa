...
skills: ["implement-print"]
output-formats: ["html", "md"]
---

# Implementprint

> Implements print-friendly layouts with @media print styles, PDF generation, and print-specific content adaptation
...
- Load skill guidelines: `skills/implement-print/knowledge/body-of-knowledge.md`
...
**Delivers**: Implements print-friendly layouts with @media print styles, PDF generation, and print-specific content adaptation
