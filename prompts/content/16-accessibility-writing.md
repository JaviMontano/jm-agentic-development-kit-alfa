---
name: 16-accessibility-writing
category: content
version: 2.0.0
description: "Alt text guidelines, plain language, reading level, inclusive language."
triad:
...
- Load skill guidelines: `skills/accessibility-writing/knowledge/body-of-knowledge.md`
...
**Delivers**: Alt text guidelines, plain language, reading level, inclusive language.
