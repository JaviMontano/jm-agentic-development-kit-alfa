...
category: business
version: 2.0.0
description: "Hypothesis formulation, statistical significance, sample size calculation, test duration."
triad:
...
- Load skill guidelines: `skills/ab-testing/knowledge/body-of-knowledge.md`
...
**Delivers**: Hypothesis formulation, statistical significance, sample size calculation, test duration.
