...
skills: ["deploy-firebase"]
output-formats: ["html", "md"]
---

# Deployfirebase

> Guides deployment to Firebase Hosting with multi-site setup, preview channels, and Cloud Functions deployment
...
- Load skill guidelines: `skills/deploy-firebase/knowledge/body-of-knowledge.md`
...
**Delivers**: Guides deployment to Firebase Hosting with multi-site setup, preview channels, and Cloud Functions deployment
