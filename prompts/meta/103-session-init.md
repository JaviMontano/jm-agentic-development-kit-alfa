---
name: 103-session-init
category: meta
version: 2.0.0
description: "Initialize a new session with context loading and state recovery"
triad:
...
> Initialize a new session with context loading and state recovery
...
- Load skill guidelines: `skills/session-init/knowledge/body-of-knowledge.md`
...
**Delivers**: Initialize a new session with context loading and state recovery
