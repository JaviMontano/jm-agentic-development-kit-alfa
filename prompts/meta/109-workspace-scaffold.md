---
name: 109-workspace-scaffold
category: meta
version: 2.0.0
description: "Scaffold workspace directory with dated session folder"
triad:
  lead: "adk-orchestrator"
  support: "integrity-validator"
  guardian: "quality-guardian"
skills: ["workspace-scaffold"]
output-formats: ["html", "md"]
---

# Workspace Scaffold

> Scaffold workspace directory with dated session folder
...
- Load skill guidelines: `skills/workspace-scaffold/knowledge/body-of-knowledge.md`
...
**Delivers**: Scaffold workspace directory with dated session folder
