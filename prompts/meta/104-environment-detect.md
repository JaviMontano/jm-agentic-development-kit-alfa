---
name: 104-environment-detect
category: meta
version: 2.0.0
description: "Detect IDE and model, adapt triad mode and skill loading"
triad:
  lead: "adk-orchestrator"
  support: "integrity-validator"
  guardian: "quality-guardian"
skills: ["environment-detect"]
output-formats: ["html", "md"]
---

# Environment Detect

> Detect IDE and model, adapt triad mode and skill loading
...
- Load skill guidelines: `skills/environment-detect/knowledge/body-of-knowledge.md`
...
**Delivers**: Detect IDE and model, adapt triad mode and skill loading
