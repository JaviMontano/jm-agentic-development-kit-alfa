---
name: 7-environment-management
category: devops
version: 2.0.0
description: "Dev/staging/prod configs, env variables, secrets rotation."
triad:
...
- Load skill guidelines: `skills/environment-management/knowledge/body-of-knowledge.md`
...
**Delivers**: Dev/staging/prod configs, env variables, secrets rotation.
