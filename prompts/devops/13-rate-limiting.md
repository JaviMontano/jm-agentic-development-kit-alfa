...
category: devops
version: 2.0.0
description: "API rate limits, throttling, quota management, abuse prevention."
triad:
...
- Load skill guidelines: `skills/rate-limiting/knowledge/body-of-knowledge.md`
...
**Delivers**: API rate limits, throttling, quota management, abuse prevention.
