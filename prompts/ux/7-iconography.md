...
category: ux
version: 2.0.0
description: "Icon systems, SVG optimization, icon accessibility, consistency."
triad:
...
- Load skill guidelines: `skills/iconography/knowledge/body-of-knowledge.md`
...
**Delivers**: Icon systems, SVG optimization, icon accessibility, consistency.
