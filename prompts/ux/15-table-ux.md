...
category: ux
version: 2.0.0
description: "Data tables, sorting, pagination, responsive tables, bulk actions."
triad:
...
- Load skill guidelines: `skills/table-ux/knowledge/body-of-knowledge.md`
...
**Delivers**: Data tables, sorting, pagination, responsive tables, bulk actions.
