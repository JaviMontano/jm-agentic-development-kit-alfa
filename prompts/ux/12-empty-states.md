---
name: 12-empty-states
category: ux
version: 2.0.0
description: "Zero-data UI, first-use experience, placeholder content, call-to-action."
triad:
...
- Load skill guidelines: `skills/empty-states/knowledge/body-of-knowledge.md`
...
**Delivers**: Zero-data UI, first-use experience, placeholder content, call-to-action.
