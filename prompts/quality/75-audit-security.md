...
> Performs a security audit covering Firebase rules, XSS, CSRF, auth vulnerabilities, and dependency scanning
...
- Load skill guidelines: `skills/audit-security/knowledge/body-of-knowledge.md`
...
**Delivers**: Performs a security audit covering Firebase rules, XSS, CSRF, auth vulnerabilities, and dependency scanning
