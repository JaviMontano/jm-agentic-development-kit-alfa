---
name: 88-visual-regression-setup
category: quality
version: 2.0.0
...
skills: ["visual-regression-setup"]
...
- Load skill guidelines: `skills/visual-regression-setup/knowledge/body-of-knowledge.md`
...
**Delivers**: Set up visual regression testing with screenshot comparison
