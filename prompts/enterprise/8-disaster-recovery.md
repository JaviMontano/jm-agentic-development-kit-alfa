...
category: enterprise
version: 2.0.0
description: "RTO/RPO targets, failover testing, business continuity planning."
triad:
...
- Load skill guidelines: `skills/disaster-recovery/knowledge/body-of-knowledge.md`
...
**Delivers**: RTO/RPO targets, failover testing, business continuity planning.
