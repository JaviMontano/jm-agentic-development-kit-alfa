---
name: 13-error-recovery-automation
category: automation
version: 2.0.0
description: "Automatic retry with exponential backoff, error classification."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["error-recovery-automation"]
...
- Load skill guidelines: `skills/error-recovery-automation/knowledge/body-of-knowledge.md`
...
**Delivers**: Automatic retry with exponential backoff, error classification.
