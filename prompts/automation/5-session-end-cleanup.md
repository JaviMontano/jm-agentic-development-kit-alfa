---
name: 5-session-end-cleanup
category: automation
version: 2.0.0
description: "Session summary generation, insight extraction, tasklog update."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["session-end-cleanup"]
...
- Load skill guidelines: `skills/session-end-cleanup/knowledge/body-of-knowledge.md`
...
**Delivers**: Session summary generation, insight extraction, tasklog update.
