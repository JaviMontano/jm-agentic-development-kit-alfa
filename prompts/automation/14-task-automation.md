---
name: 14-task-automation
category: automation
version: 2.0.0
description: "Recurring task scheduling, batch operations, periodic health checks."
triad:
...
- Load skill guidelines: `skills/task-automation/knowledge/body-of-knowledge.md`
...
**Delivers**: Recurring task scheduling, batch operations, periodic health checks.
