---
name: 4-session-start-bootstrap
category: automation
version: 2.0.0
description: "Context loading, environment detection, guardrails initialization."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["session-start-bootstrap"]
...
- Load skill guidelines: `skills/session-start-bootstrap/knowledge/body-of-knowledge.md`
...
**Delivers**: Context loading, environment detection, guardrails initialization.
