---
name: 10-permission-fast-path
category: automation
version: 2.0.0
description: "Auto-approve read-only operations to reduce LLM overhead."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["permission-fast-path"]
...
- Load skill guidelines: `skills/permission-fast-path/knowledge/body-of-knowledge.md`
...
**Delivers**: Auto-approve read-only operations to reduce LLM overhead.
