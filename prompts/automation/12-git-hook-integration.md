---
name: 12-git-hook-integration
category: automation
version: 2.0.0
description: "Pre-commit and pre-push hooks, conventional commit enforcement."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["git-hook-integration"]
...
- Load skill guidelines: `skills/git-hook-integration/knowledge/body-of-knowledge.md`
...
**Delivers**: Pre-commit and pre-push hooks, conventional commit enforcement.
