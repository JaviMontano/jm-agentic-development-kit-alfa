---
name: 1-pre-tool-use-guard
category: automation
version: 2.0.0
description: "Block dangerous commands before execution using exit code 2 pattern."
triad:
  lead: "workflow-orchestration-specialist"
  support: "error-recovery-automation-specialist"
  guardian: "quality-guardian"
skills: ["pre-tool-use-guard"]
...
- Load skill guidelines: `skills/pre-tool-use-guard/knowledge/body-of-knowledge.md`
...
**Delivers**: Block dangerous commands before execution using exit code 2 pattern.
